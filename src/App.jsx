    ...
    <div className="fixed inset-0 bg-gradient-to-r from-blue-50 to-blue-100">
      <div className="h-full max-w-4xl mx-auto flex flex-col p-3">
        ...
        <header className="text-center py-4">
          <a href="https://github.com/parthib-312" 
             target="_blank" 
        ...
        <form onSubmit={generateAnswer} className="bg-white rounded-lg shadow-lg p-4">
          <div className="flex gap-2">
            <textarea
              required
              className="flex-1 border border-gray-400 rounded p-3 focus:border-blue-400 focus:ring-1 focus:ring-blue-400 resize-none bg-gray-200"
              value={question}
